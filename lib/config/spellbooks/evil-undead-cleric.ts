  ...
  spells: [
    ...
    },
    {
      ...
      values: [
        ...
        {
          level: 3,
          base: [s.AnimateDead, s.GlyphOfWarding, FNP_SPELLS.Priest.ShadowMonsters],
          additionnals: [s.HolySmite, s.CauseDisease, s.Contagion, s.MiscastMagic, s.RigidThinking],
          repeat: [s.AnimateDead, s.GlyphOfWarding, s.HolySmite],
        },
        {
          level: 4,
          base: [s.CloudOfPestilence, s.MentalDomination, FNP_SPELLS.Priest.DemiShadowMonsters],
          additionnals: [
            s.HolyPower,
            s.Poison,
            s.CauseSeriousWounds,
        ...
        {
          level: 5,
          base: [s.GreaterCommand, FNP_SPELLS.Priest.Shades, s.SlayLiving],
          additionnals: [
            s.FlameStrike,
            s.MagicResistance,
            s.PhysicalMirror,
        ...
        {
          level: 6,
          base: [s.AnimateSkeletonWarrior, FNP_SPELLS.Priest.SummonShadows, s.EntropyShield],
          additionnals: [s.BladeBarrier, s.BoltOfGlory, s.DolorousDecay, s.Harm, s.Banishment],
          repeat: [s.AnimateSkeletonWarrior, s.DolorousDecay],
        },
        {
